...
## [2.177.0](https://github.com/esinanturan/gotrue/compare/v2.176.1...v2.177.0) (2025-07-30)


### Features

* add `GOTRUE_<PROVIDER>_SKIP_NONCE_CHECK` to skip nonce checks in ODIC flow ([#1264](https://github.com/esinanturan/gotrue/issues/1264)) ([4291959](https://github.com/esinanturan/gotrue/commit/4291959c4057332633265745073d26dc0e548898))
...
* add cleanup for session timebox and inactivity timeout ([#1298](https://github.com/esinanturan/gotrue/issues/1298)) ([9226979](https://github.com/esinanturan/gotrue/commit/92269796c7cb515f4c1e905220c1a1fd8c6764d5))
...
* add email rate limit breach metric ([#1208](https://github.com/esinanturan/gotrue/issues/1208)) ([4ff1fe0](https://github.com/esinanturan/gotrue/commit/4ff1fe058cfab418c445808004091e89dcf87124))
...
* add endpoint to unlink identity from user ([#1315](https://github.com/esinanturan/gotrue/issues/1315)) ([af83b34](https://github.com/esinanturan/gotrue/commit/af83b34850dfe7d983a41a8fb5d02d325ee72985))
...
* add fly oauth provider ([#1261](https://github.com/esinanturan/gotrue/issues/1261)) ([0fe4285](https://github.com/esinanturan/gotrue/commit/0fe4285873cea1f6815170a2da1589838b66d8af))
* add friendly name to enroll factor response ([#1277](https://github.com/esinanturan/gotrue/issues/1277)) ([3c72faf](https://github.com/esinanturan/gotrue/commit/3c72faf2b6c83d16f5a438d106c07fe40ec5f49e))
...
* add idempotent refresh token algorithm ([#1278](https://github.com/esinanturan/gotrue/issues/1278)) ([b0426c6](https://github.com/esinanturan/gotrue/commit/b0426c6b7cfc3060ff0efa72e9d70a574e1f3ab6))
* add inactivity-timeout to sessions ([#1288](https://github.com/esinanturan/gotrue/issues/1288)) ([6c8a96e](https://github.com/esinanturan/gotrue/commit/6c8a96e39190e1d499ab667fcd24bed2b2fa01c8))
* add index on user_id of mfa_factors ([#1247](https://github.com/esinanturan/gotrue/issues/1247)) ([6ea135a](https://github.com/esinanturan/gotrue/commit/6ea135aa5e6745ff7cbd2e2df242218a66025ca8))
...
* add kakao OIDC ([#1381](https://github.com/esinanturan/gotrue/issues/1381)) ([b5566e7](https://github.com/esinanturan/gotrue/commit/b5566e7ac001cc9f2bac128de0fcb908caf3a5ed))
...
* add new Linkedin OIDC due to deprecated scopes for new linkedin applications ([#1248](https://github.com/esinanturan/gotrue/issues/1248)) ([f40acfe](https://github.com/esinanturan/gotrue/commit/f40acfe3d1f852dd806797c00997a4e04949ff51))
...
* add single session per user with tags support ([#1297](https://github.com/esinanturan/gotrue/issues/1297)) ([69feebc](https://github.com/esinanturan/gotrue/commit/69feebc43358f3462c527c2b5b777235e1e804bd))
...
* add sso pkce ([#1137](https://github.com/esinanturan/gotrue/issues/1137)) ([2c0e0a1](https://github.com/esinanturan/gotrue/commit/2c0e0a1e44b073770e02b101a357e80a11ba5b6e))
...
* add time-boxed sessions ([#1286](https://github.com/esinanturan/gotrue/issues/1286)) ([9a1f461](https://github.com/esinanturan/gotrue/commit/9a1f4613eb3e6dd2af3ce76b07256fd80ddbc708))
* add timeout middleware ([#1529](https://github.com/esinanturan/gotrue/issues/1529)) ([f96ff31](https://github.com/esinanturan/gotrue/commit/f96ff31040b28e3a7373b4fd41b7334eda1b413e))
...
* allow unverified email signins ([#1301](https://github.com/esinanturan/gotrue/issues/1301)) ([94293b7](https://github.com/esinanturan/gotrue/commit/94293b72b829436308050be5399069976b810cdb))
...
* expose email address being sent to for email change flow ([#1231](https://github.com/esinanturan/gotrue/issues/1231)) ([f7308ad](https://github.com/esinanturan/gotrue/commit/f7308ad9355db7526a30798b8aa17dabff9f543b))
* fallback to jwt secret if alg is `HS256` and the `kid` is not recognized ([#2072](https://github.com/esinanturan/gotrue/issues/2072)) ([8fa99bd](https://github.com/esinanturan/gotrue/commit/8fa99bd6cab91c0bf093fdcdb912054113ea66ba))
...
* fix empty string parsing for `GOTRUE_SMS_TEST_OTP_VALID_UNTIL` ([#1234](https://github.com/esinanturan/gotrue/issues/1234)) ([25f2dcb](https://github.com/esinanturan/gotrue/commit/25f2dcbc97bac18266f1d3583614656182154f85))
...
* fix refresh token reuse revocation ([#1312](https://github.com/esinanturan/gotrue/issues/1312)) ([6e313f8](https://github.com/esinanturan/gotrue/commit/6e313f813fc14337a3cd0bdd898f76fe02c9be40))
...
* ignore common Azure issuer for ID tokens ([#1272](https://github.com/esinanturan/gotrue/issues/1272)) ([4c50357](https://github.com/esinanturan/gotrue/commit/4c50357841c51c2da0eff4d7f8920aed5e640df2))
...
* initial fix for invite followed by signup. ([#1262](https://github.com/esinanturan/gotrue/issues/1262)) ([76c8eeb](https://github.com/esinanturan/gotrue/commit/76c8eeb7275d47f2c7a4029219fa7b3ca4c26da8))
...
* merge provider metadata on link account ([#1552](https://github.com/esinanturan/gotrue/issues/1552)) ([bd8b5c4](https://github.com/esinanturan/gotrue/commit/bd8b5c41dd544575e1a52ccf1ef3f0fdee67458c))
...
* password sign-up no longer blocks the db connection ([#1319](https://github.com/esinanturan/gotrue/issues/1319)) ([84d4b75](https://github.com/esinanturan/gotrue/commit/84d4b751ae71c9e5a7c8f61a6692486ff09d86a3))
...
* refactor for central password strength check ([#1321](https://github.com/esinanturan/gotrue/issues/1321)) ([5524653](https://github.com/esinanturan/gotrue/commit/5524653b0c375872ab49694f0dc99a2093886187))
...
* reinstate upgrade whatsapp support on Twilio Programmable Messaging to support Content API ([#1266](https://github.com/esinanturan/gotrue/issues/1266)) ([00ee75c](https://github.com/esinanturan/gotrue/commit/00ee75c5509facc668295a57ba9130064c267b31))
* remove legacy lookup in users for one_time_tokens (phase II) ([#1569](https://github.com/esinanturan/gotrue/issues/1569)) ([39ca026](https://github.com/esinanturan/gotrue/commit/39ca026035f6c61d206d31772c661b326c2a424c))
...
* remove opentracing ([#1307](https://github.com/esinanturan/gotrue/issues/1307)) ([93e5f82](https://github.com/esinanturan/gotrue/commit/93e5f82ced83c08799ce99020be9dea82fc56d24))
...
* spotify oauth ([#1296](https://github.com/esinanturan/gotrue/issues/1296)) ([cc07b4a](https://github.com/esinanturan/gotrue/commit/cc07b4aa2ace75d9c8e46ae5107dbabadf944e87))
* strip user-agent from otel tracing ([#1309](https://github.com/esinanturan/gotrue/issues/1309)) ([d76f439](https://github.com/esinanturan/gotrue/commit/d76f439b65413803ccf37cf8a217a932addfb477))
...
* update primary key for identities table ([#1311](https://github.com/esinanturan/gotrue/issues/1311)) ([d8ec801](https://github.com/esinanturan/gotrue/commit/d8ec8015e50f6199786a9e5f05589888fa8862be))
...
* upgrade whatsapp support on Twilio Programmable Messaging ([#1249](https://github.com/esinanturan/gotrue/issues/1249)) ([c58febe](https://github.com/esinanturan/gotrue/commit/c58febed896c7152a03634ac32b7f596b7b65d6f))
* use `DO` blocks around SQL statements in migrations ([#1335](https://github.com/esinanturan/gotrue/issues/1335)) ([061391a](https://github.com/esinanturan/gotrue/commit/061391aceed64b2cac56e8a82b6a3da3e83cbb14))
...
* use `template/text` instead of `strings.Replace` for phone OTP messages ([#1188](https://github.com/esinanturan/gotrue/issues/1188)) ([5caacc1](https://github.com/esinanturan/gotrue/commit/5caacc1f81ff20f8f09f4598b510c767e589a1c5))
...
* use OIDC ID token for Azure ([#1269](https://github.com/esinanturan/gotrue/issues/1269)) ([57e336e](https://github.com/esinanturan/gotrue/commit/57e336e9c0d8f8fc27e5efeecf06bff5507fef54))
...
* [#1218](https://github.com/esinanturan/gotrue/issues/1218) fixes existing migrations to allow namespaces!="auth" ([#1279](https://github.com/esinanturan/gotrue/issues/1279)) ([206fc09](https://github.com/esinanturan/gotrue/commit/206fc0908992e6c22a6343a7a7517f66322764b5))
...
* add missing provider info to signedup audit logs ([#2061](https://github.com/esinanturan/gotrue/issues/2061)) ([c6e0cbe](https://github.com/esinanturan/gotrue/commit/c6e0cbefe5b609ac3362c23d0f7cb9d9bb04abc9))
* add redirectTo to email templates ([#1276](https://github.com/esinanturan/gotrue/issues/1276)) ([40aed62](https://github.com/esinanturan/gotrue/commit/40aed622f24066b2718e4509a001026fe7d4b76d))
...
* allow transactions to be committed while returning a custom error ([#1310](https://github.com/esinanturan/gotrue/issues/1310)) ([8565d26](https://github.com/esinanturan/gotrue/commit/8565d264014557f721b6d12afa3171a25a38b905))
...
* check for pkce prefix ([#1291](https://github.com/esinanturan/gotrue/issues/1291)) ([05c629b](https://github.com/esinanturan/gotrue/commit/05c629b1b521e950e8951e9e8d328c9813ebe6bd))
...
* cleanup panics due to bad inactivity timeout code ([#1471](https://github.com/esinanturan/gotrue/issues/1471)) ([548edf8](https://github.com/esinanturan/gotrue/commit/548edf898161c9ba9a136fc99ec2d52a8ba1f856))
...
* disable allow unverified email sign ins if autoconfirm enabled ([#1313](https://github.com/esinanturan/gotrue/issues/1313)) ([9b93ac1](https://github.com/esinanturan/gotrue/commit/9b93ac1d988519354a59ecff573ba22718896971))
...
* explicit permisions on actions ([#1978](https://github.com/esinanturan/gotrue/issues/1978)) ([06e9ead](https://github.com/esinanturan/gotrue/commit/06e9ead3e09e77631597a953a535cb93dd006c7f))
...
* improve default settings used  ([4745451](https://github.com/esinanturan/gotrue/commit/4745451a931c2be5d36c07b37bd0eb3ab7780587))
...
* improve saml assertion logging ([#1915](https://github.com/esinanturan/gotrue/issues/1915)) ([d6030cc](https://github.com/esinanturan/gotrue/commit/d6030ccd271a381e2a6ababa11a5beae4b79e5c3))
...
* include `/organizations` in expected issuer exemption ([#1275](https://github.com/esinanturan/gotrue/issues/1275)) ([47cbe6e](https://github.com/esinanturan/gotrue/commit/47cbe6e481ccec9d7f533c7fdba0328c8f6227e5))
...
* log clearer internal error messages for verify ([#1292](https://github.com/esinanturan/gotrue/issues/1292)) ([aafad5c](https://github.com/esinanturan/gotrue/commit/aafad5c2b073f0f56239109eef2cf5f2ee5cfd70))
...
* omit empty string from name & use case-insensitive equality for comparing SAML attributes ([#1654](https://github.com/esinanturan/gotrue/issues/1654)) ([bf5381a](https://github.com/esinanturan/gotrue/commit/bf5381a6b1c686955dc4e39fe5fb806ffd309563))
...
* pass through redirect query parameters ([#1224](https://github.com/esinanturan/gotrue/issues/1224)) ([577e320](https://github.com/esinanturan/gotrue/commit/577e3207aab8ee4c4661f5a8148f02296210f1d8))
* patch secure email change (double confirm) response format. ([#1241](https://github.com/esinanturan/gotrue/issues/1241)) ([064e8a1](https://github.com/esinanturan/gotrue/commit/064e8a1a1a71163d81f6c549b31148b88c3ef7be))
...
* preserve backward compatibility with Twilio Existing API ([#1260](https://github.com/esinanturan/gotrue/issues/1260)) ([71fb156](https://github.com/esinanturan/gotrue/commit/71fb1569c9daff8ac99ae6b9626e098606b2934f))
...
* remove deprecated LogoutAllRefreshTokens ([#1519](https://github.com/esinanturan/gotrue/issues/1519)) ([35533ea](https://github.com/esinanturan/gotrue/commit/35533ea100669559e1209ecc7b091db3657234d9))
...
* remove organizations from fly provider ([#1267](https://github.com/esinanturan/gotrue/issues/1267)) ([c79fc6e](https://github.com/esinanturan/gotrue/commit/c79fc6e41988e2854e3e30c7c3f96b1374bdf983))
...
* Revert "fix: remove organizations from fly provider" ([#1287](https://github.com/esinanturan/gotrue/issues/1287)) ([84e16ed](https://github.com/esinanturan/gotrue/commit/84e16ed362a38610deee94b9dbea48a855a1fbbe))
...
* sanitizeUser leaks user role ([#1366](https://github.com/esinanturan/gotrue/issues/1366)) ([8ce9d3f](https://github.com/esinanturan/gotrue/commit/8ce9d3f7d93afb056b7ecd151545270a46002ae6))
...
* set the otp if it's not a test otp ([#1223](https://github.com/esinanturan/gotrue/issues/1223)) ([3afc8a9](https://github.com/esinanturan/gotrue/commit/3afc8a9a309d20a7f582f83f94a2776b1d3e13f7))
...
* take into account test otp for twilio verify ([#1255](https://github.com/esinanturan/gotrue/issues/1255)) ([18b4291](https://github.com/esinanturan/gotrue/commit/18b4291ea00eb0f95229f5dbe5d6474c1e563b4d))
* test otp with twilio verify ([#1259](https://github.com/esinanturan/gotrue/issues/1259)) ([ab2aba6](https://github.com/esinanturan/gotrue/commit/ab2aba69ae0261454eaef1dc9dacf8717f0bbe15))
...
* update dependencies (1/2) ([#1304](https://github.com/esinanturan/gotrue/issues/1304)) ([accccee](https://github.com/esinanturan/gotrue/commit/accccee91650880e530a7d9b2cd62bb5cc4a7266))
...
* upgrade ci Go version ([#1782](https://github.com/esinanturan/gotrue/issues/1782)) ([97a48f6](https://github.com/esinanturan/gotrue/commit/97a48f6daaa2edda5b568939cbb1007ccdf33cfc))
...
* use linkedin oidc endpoint ([#1254](https://github.com/esinanturan/gotrue/issues/1254)) ([6d5c8eb](https://github.com/esinanturan/gotrue/commit/6d5c8ebb4c894d028e90493a35f43eae1d6c5e7d))
